 ...
 * @author tu
 */
public class TableDateScheduleStudentAjax extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Schedule> schedules = stuDB.getScheduleStudent(studentId, fromDate, toDate);
        ...
        request.getRequestDispatcher("../../../../ajax/student/scheduleTableDate.jsp").forward(request, response);
    }
