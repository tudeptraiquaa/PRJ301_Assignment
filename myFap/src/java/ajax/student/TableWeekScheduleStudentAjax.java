 ...
 * @author tu
 */
public class TableWeekScheduleStudentAjax extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Schedule> schedules = stuDB.getScheduleStudent(studentId, week, year);
        ArrayList<IDate> dates = iWeek.getDateInWeek();
        ...
        request.getRequestDispatcher("../../../../ajax/student/scheduleTableWeek.jsp").forward(request, response);
    }
